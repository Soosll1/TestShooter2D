...
public partial class GameEntity {
    ...
    public Gameplay.Common.Health health { get { return (Gameplay.Common.Health)GetComponent(GameComponentsLookup.Health); } }
    ...
    public GameEntity AddHealth(float newValue) {
        ...
        var component = (Gameplay.Common.Health)CreateComponent(index, typeof(Gameplay.Common.Health));
