...
public partial class GameEntity {
    ...
    public Common.View view { get { return (Common.View)GetComponent(GameComponentsLookup.View); } }
    public Infrastructure.View.IEntityView View { get { return view.Value; } }
    public bool hasView { get { return HasComponent(GameComponentsLookup.View); } }

    public GameEntity AddView(Infrastructure.View.IEntityView newValue) {
        var index = GameComponentsLookup.View;
        var component = (Common.View)CreateComponent(index, typeof(Common.View));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceView(Infrastructure.View.IEntityView newValue) {
        var index = GameComponentsLookup.View;
        var component = (Common.View)CreateComponent(index, typeof(Common.View));
        component.Value = newValue;
