...
public partial class GameEntity {
    ...
    public Gameplay.Common.ViewPath viewPath { get { return (Gameplay.Common.ViewPath)GetComponent(GameComponentsLookup.ViewPath); } }
    ...
    public GameEntity AddViewPath(string newValue) {
        ...
        var component = (Gameplay.Common.ViewPath)CreateComponent(index, typeof(Gameplay.Common.ViewPath));
