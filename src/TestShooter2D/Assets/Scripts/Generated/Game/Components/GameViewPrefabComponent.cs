...
public partial class GameEntity {
    ...
    public Gameplay.Common.ViewPrefab viewPrefab { get { return (Gameplay.Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public Infrastructure.View.EntityBehaviour ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Gameplay.Common.ViewPrefab)CreateComponent(index, typeof(Gameplay.Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(Infrastructure.View.EntityBehaviour newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Gameplay.Common.ViewPrefab)CreateComponent(index, typeof(Gameplay.Common.ViewPrefab));
        component.Value = newValue;
