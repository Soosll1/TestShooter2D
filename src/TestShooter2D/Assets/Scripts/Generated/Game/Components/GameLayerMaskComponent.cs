...
public partial class GameEntity {
    ...
    public Gameplay.Features.TargetCollection.LayerMask layerMask { get { return (Gameplay.Features.TargetCollection.LayerMask)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Gameplay.Features.TargetCollection.LayerMask)CreateComponent(index, typeof(Gameplay.Features.TargetCollection.LayerMask));
