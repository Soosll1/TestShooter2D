...
public partial class GameEntity {
    ...
    public Gameplay.Features.Armament.Damage damage { get { return (Gameplay.Features.Armament.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Gameplay.Features.Armament.Damage)CreateComponent(index, typeof(Gameplay.Features.Armament.Damage));
