...
namespace Gameplay.Common.Physics
{
  public class PhysicsService : IPhysicsService
  {
    ...
    public IEnumerable<global::Common.Entity.ToStrings.GameEntity> RaycastAll(Vector2 worldPosition, Vector2 direction, int layerMask)
    {
      ...
      for (int i = 0; i < hitCount; i++)
      {
        ...
        global::Common.Entity.ToStrings.GameEntity entity = _collisionRegistry.Get<global::Common.Entity.ToStrings.GameEntity>(hit.collider.GetInstanceID());
        if (entity == null)
          continue;
    ...
    public global::Common.Entity.ToStrings.GameEntity Raycast(Vector2 worldPosition, Vector2 direction, int layerMask)
    {
      int hitCount = Physics2D.RaycastNonAlloc(worldPosition, direction, Hits, layerMask);
    ...
    public global::Common.Entity.ToStrings.GameEntity LineCast(Vector2 start, Vector2 end, int layerMask)
    {
